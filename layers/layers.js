...
var format_Kelompok5_6 = new ol.format.GeoJSON();
var features_Kelompok5_6 = format_Kelompok5_6.readFeatures(json_Kelompok5_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Kelompok5_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Kelompok5_6.addFeatures(features_Kelompok5_6);cluster_Kelompok5_6 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_Kelompok5_6
});
var lyr_Kelompok5_6 = new ol.layer.Vector({
                declutter: true,
                source:cluster_Kelompok5_6, 
                style: style_Kelompok5_6,
                interactive: true,
                title: '<img src="styles/legend/Kelompok5_6.png" /> Kelompok 5'
            });
var format_Kelompok4_7 = new ol.format.GeoJSON();
var features_Kelompok4_7 = format_Kelompok4_7.readFeatures(json_Kelompok4_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Kelompok4_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Kelompok4_7.addFeatures(features_Kelompok4_7);
var lyr_Kelompok4_7 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Kelompok4_7, 
                style: style_Kelompok4_7,
                interactive: true,
                title: '<img src="styles/legend/Kelompok4_7.png" /> Kelompok 4'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_Kelompok7_1.setVisible(true);lyr_Kelompok2_2.setVisible(true);lyr_Kelompok3_3.setVisible(true);lyr_Kelompok6_4.setVisible(true);lyr_Kelompok1_5.setVisible(true);lyr_Kelompok5_6.setVisible(true);lyr_Kelompok4_7.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_Kelompok7_1,lyr_Kelompok2_2,lyr_Kelompok3_3,lyr_Kelompok6_4,lyr_Kelompok1_5,lyr_Kelompok5_6,lyr_Kelompok4_7];
...
lyr_Kelompok5_6.set('fieldAliases', {'X': 'X', 'Y': 'Y', 'Image': 'Image', 'Alamat': 'Alamat', 'Ketinggian': 'Ketinggian', 'poto': 'poto', });
lyr_Kelompok4_7.set('fieldAliases', {'Y': 'Y', 'X': 'X', 'Ketinggian': 'Ketinggian', 'Foto': 'Foto', 'imge': 'imge', });
...
lyr_Kelompok5_6.set('fieldImages', {'X': 'TextEdit', 'Y': 'TextEdit', 'Image': 'TextEdit', 'Alamat': 'TextEdit', 'Ketinggian': 'TextEdit', 'poto': 'ExternalResource', });
lyr_Kelompok4_7.set('fieldImages', {'Y': '', 'X': '', 'Ketinggian': '', 'Foto': '', 'imge': '', });
...
lyr_Kelompok5_6.set('fieldLabels', {'X': 'inline label', 'Y': 'inline label', 'Image': 'no label', 'Alamat': 'inline label', 'Ketinggian': 'inline label', 'poto': 'inline label', });
lyr_Kelompok4_7.set('fieldLabels', {'Y': 'inline label', 'X': 'inline label', 'Ketinggian': 'inline label', 'Foto': 'no label', 'imge': 'no label', });
lyr_Kelompok4_7.on('precompose', function(evt) {
